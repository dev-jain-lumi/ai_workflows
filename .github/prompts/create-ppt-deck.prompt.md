...
description: "Create a presentation deck with repeatable inputs such as topic, audience, objective, and slide count. Uses the ppt-generation agent and writes outputs under AI_Luminus/presentations. Trigger phrases: create ppt deck, make slides, build presentation, create presentation, generate slide deck."
...
- Output folder: ${input:Folder under AI_Luminus/presentations}
...
- Create source files under AI_Luminus/presentations only.
...
- If the output folder input is not already under AI_Luminus/presentations, normalize it to a subfolder there.
